...
?>
    <title>Editar Administrador | 4x1</title>
                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content mt-2 mb-3" id="pills-tabContent">
                            <div class="tab-pane fade show active" id="editar-admin" role="tabpanel" aria-labelledby="editar-admin-tab">
                                <form action="adminInserir?idAdmin=<?php echo $idAdmin ?>&op=edit" method="POST" onsubmit="return verificarPasswords()">
                                    <div class="page-inner">
                                        <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4" style="text-align: center;">
                                            <div>
                                                <h2 class="fw-bold mb-3">Ficha do administrador</h2>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-section">
                                                <div class="form-row">
                                                    <div class="campo" style="flex: 0 0 99.5%;">
                                                        <label>NOME:</label>
                                                        <input type="text" name="nome" value="<?php echo $rowAdmin['nome']; ?>">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-row">
                                                    <div class="campo" style="flex: 0 0 78%;">
                                                        <label>EMAIL:</label>
                                                        <input type="email" name="email" value="<?php echo $rowAdmin['email']; ?>">
                                                    </div>
                                                    <div class="campo" style="flex: 0 0 20%;">
                                                        <label>ESTADO:</label>
                                                        <select name="estado" class="select-box">
                                                            <option <?php if ($rowAdmin['active'] == 1) { echo "selected"; }?> value="Ativo">Ativo</option>
                                                            <option <?php if ($rowAdmin['active'] == 0) { echo "selected"; }?> value="Inativo">Desativado</option>
                                                        </select>
                                                    </div>
                                                </div>
