        ...
        ?>
            <div class="container">
                <div class="page-inner">
                    ...
                    >
                        <div>
                            <h3 class="fw-bold mb-3 mb-md-0">Recibos alunos</h3>
                        </div>
                        <div>
                            <a href="recibosNotificacao" class="btn btn-primary">Notificar alunos</a>
                        </div>
                    </div>
                        <div class="col-md-12">
                            <div class="card">
                                                                    ...
                                                                    <td>
                                                                        <div class="form-button-action">
                                                                            ...
                                                                            <?php } else if ($row['notificacao'] == "Pendente") { ?>
                                                                                <a
                                                                                    href="recibosNotificacao?idRecibo=<?php echo $row['idRecibo']; ?>&source=recibosAlunos"
                                                                                    class="btn btn-link btn-primary btn-lg"
                                                                                    data-bs-toggle="tooltip"
                                                                                    data-bs-placement="top"
